...
class MobileSpider(BaseSpider):
    ...
    urls = [
        ...
        ('Suzuki SV650', 'https://suchen.mobile.de/fahrzeuge/search.html?damageUnrepaired=NO_DAMAGE_UNREPAIRED&features=WINDSHIELD&isSearchRequest=true&lang=en&makeModelVariant1.makeId=23600&makeModelVariant1.modelDescription=SV&maxCubicCapacity=700&maxPowerAsArray=KW&minCubicCapacity=550&minFirstRegistrationDate=2004-01-01&minPowerAsArray=KW&scopeId=MB&sortOption.sortBy=searchNetGrossPrice&sortOption.sortOrder=ASCENDING'),
    ...
    def parse_item_page(self, response):
        ...
        images = container.css('#rbt-image-gallery img::attr(src)').extract()
        images.extend(container.css('#rbt-image-gallery img::attr(data-lazy)').extract())
